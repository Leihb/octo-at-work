...
| screenshot | 截图 | 拍下来了，但 DeepSeek 这个模型看不了图，它自己说"当前模型无视觉能力" |
...
听起来很合理。我让 Roy 看了一眼那个标签页右上角：是他的头像，登录着。**诊断是错的。**
...
**没有视觉的模型，截图是白拍。** DeepSeek 这个模型收到截图会说"图片读不到"。它这两轮拍了三次，三次都白拍，
然后换别的办法。换一个能看图的模型，浏览器这一章会顺很多。
